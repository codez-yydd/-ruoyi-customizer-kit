              ...
              <template #item="{ element, index }">
                ...
                <div class="select-line-icon option-drag">
                  ...
                  <el-input
                    ...
                    @update:model-value="setOptionValue(element, $event)"
                  />
...
<script setup>
import { computed, h, reactive, ref, resolveComponent, toRefs } from 'vue';

import { CirclePlus, Close, Link, Operation, Pointer, Remove } from '@element-plus/icons-vue';
import draggable from 'vuedraggable';

import { inputComponents, selectComponents } from '#/utils/generator/config';
import { isNumberStr } from '#/utils/generatorHelpers';
