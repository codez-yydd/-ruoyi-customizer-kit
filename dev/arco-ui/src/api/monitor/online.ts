...
/** 在线用户分页列表：GET /monitor/online/list */
export function listOnline(query: OnlineQuery): Promise<PageResult<OnlineUser>> {
  return request.get<PageResult<OnlineUser>, PageResult<OnlineUser>>('/monitor/online/list', {
    params: query
  })
}

/** 强退在线会话：DELETE /monitor/online/{tokenId} */
