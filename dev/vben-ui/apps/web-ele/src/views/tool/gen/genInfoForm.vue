...
import { listMenu, type SysMenu } from '#/api/system/menu';
import type { GenTable, GenTableColumn } from '#/api/tool/gen';

/**
 * 代码生成 - 生成信息表单
 * 上级菜单使用 ElTreeSelect；菜单树由平铺 list 自行组装。
 */
defineOptions({ name: 'ToolGenInfoForm' });
...
/** 平铺菜单转树（与系统菜单页一致） */
function buildMenuTree(items: SysMenu[], parentId = 0): SysMenu[] {
...
<template>
  <el-form v-if="info" ref="genInfoForm" :model="info" :rules="rules" label-width="150px">
    <el-row>
      <el-col :span="12">
      ...
      <el-col v-if="info.genType == '1'" :span="24">
        <el-form-item prop="genPath">
          ...
          <el-input v-model="info.genPath">
            <template #append>
              <el-dropdown>
                <el-button type="primary">最近路径快速选择</el-button>
                <template #dropdown>
                  <el-dropdown-menu>
