  ...
  <div class="container">
    ...
    <div class="center-board">
      <div class="action-bar">
        <el-button type="primary" text :icon="Download" @click="download">
          导出vue文件
        </el-button>
        <el-button class="copy-btn-main" type="primary" text :icon="DocumentCopy" @click="copy">
          复制代码
        </el-button>
        <el-button class="delete-btn" text type="danger" :icon="Delete" @click="empty">
          清空
        </el-button>
      </div>
...
import { beautifierConf } from '#/utils/generatorHelpers';

import CodeTypeDialog from './CodeTypeDialog.vue';
import DraggableItem from './DraggableItem.vue';
import RightPanel from './RightPanel.vue';

defineOptions({ name: 'ToolBuild' });
